...
1. Доступность сервиса — успешность HTTP-запросов.
2. Производительность сервиса — количество запросов и время ответа.
3. Загрузка CPU.
4. Свободное место на диске, поскольку отчеты сохраняются локально.
5. Количество успешно сформированных и неуспешных отчетов.
